...
export const DETAIL_PROJECT_SAGA = "DETAIL_PROJECT_SAGA";
...
export const GET_USER_BY_PROJECT_ID = "GET_USER_PROJECTID";

export const GET_USER_BY_PROJECT_ID_SAGA = "GET_USER_PROJECTID_SAGA";
